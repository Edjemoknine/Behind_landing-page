      ...
      <section className=" md:mt-20">
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 space-y-3 border-2 hover:shadow-2xl duration-300 shadow-gray-700 cursor-pointer border-blue-400 dark:border-blue-300 rounded-xl">
            ...
            <div className="p-8 space-y-3 border-2 hover:shadow-2xl duration-300 shadow-gray-400 cursor-pointer border-blue-400 dark:border-blue-300 rounded-xl">
              <span className="inline-block text-blue-500 dark:text-blue-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-8 h-8"
